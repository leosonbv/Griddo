...
/// Pass a list of these to the multi-source overloads of <see cref="MetadataBuilder"/> and
/// <see cref="GridApplier"/> so that fields from each source can be edited and
...
public sealed record RegistryGroup(
    string SourceName,
